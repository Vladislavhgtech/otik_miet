...
/*
Вывод представлен в отчете
*/ 

/*
Задание Л2.з8. С помощью функции 𝑝𝑟𝑖𝑛𝑡𝐷𝑢𝑚𝑝() задания Л2.з5 определите
и выпишите в отчёт, как хранятся в памяти на платформах из таблицы Л2.2
*/

char str1[]="jzyx";
int N_str=sizeof(str1);
printDump(&str1,N_str);
cout << endl << "-----------------------"<< endl;

char str2[]="ёяюэ";
int N_str2=sizeof(str2);
printDump(&str2,N_str2);
cout << endl << "-----------------------"<< endl;

wchar_t str3[]=L"jzyx";
int N_str3=sizeof(str3);
printDump(&str3,N_str3);
cout << endl << "-----------------------"<< endl;

wchar_t str4[]=L"ёяюэ";
int N_str4=sizeof(str4);
printDump(&str4,N_str4);

cout << endl << "--------GNU/Linux 64---------"<< endl;
cout << endl << "------------end 2.8------------"<< endl;
return 0;
